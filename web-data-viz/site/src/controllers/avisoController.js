...
function publicar(req, res) {
    ...
    var fkhashtags = req.body.fkhashtags;

    if (fkhashtags == undefined) {
        ...
        avisoModel.publicar(idUsuario, comentario, fkhashtags)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function editar(req, res) {
    ...
    avisoModel.editar(novoComentario, idUsuario)
        .then(
            function (resultado) {
                res.json(resultado);
            }
